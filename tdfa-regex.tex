...
Since a history is actually a list of positions in the matched string, we will write it
as $h_i=[x_1, \dots, x_m]$ to describe that past matches occurred
...
transitions have been followed.
