...
groups, but all of them. We do this by storing in every thread 
a history of the all groups using the flyweight pattern. 

Thus, we log
enough information during parsing to build up the complete AST at
the end of the mathcing phase.
\end{abstract}
...
the transitions in the graph. The transition into a capture group is tagged
by a commit, the transition out of a capture group is tagged by
