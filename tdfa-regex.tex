...
including instructions, as we go. This is what we mean when we say that the 
DFA is \emph{lazily compiled}.
...
\section{Conclusion}
When a regular expression engine matches input, it can construct the entire parse tree
of this matching, at no or little additional computational cost.
