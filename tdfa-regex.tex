...
pair of entries, and each entry can be escaped to contain semicolons, as in the regular expression \texttt{((".*?"|[a-z]*),(".*?"|[a-z]*);)+}.
...
The power of our approach comes from the fact that matching a large chunk of text at once,
all greediness restrictions are applied globally. 
